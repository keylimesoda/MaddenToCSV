...
$global:ListenThread = $null
$global:AsyncObject
$global:doStartServer
$global:doStopServer
$global:port = 8080
$global:serverAddr
...
else
{
   ...
   if ($global:ipAddress -ne "") {$newProcess.Arguments += " -ipAddress $global:ipAddress"}
...
#//////////////////////////////////////////////////////////////////
#//Create and start UI (credit to POSHGUI.com  a free online gui designer for PowerShell)
#//////////////////////////////////////////////////////////////////
...
$MainForm.ClientSize             = New-Object System.Drawing.Point(400,228)
$MainForm.text                   = "MaddenToCSV"
$MainForm.TopMost                = $false
$MainForm.FormBorderStyle        = 'Fixed3D'
$MainForm.MaximizeBox            = $false
$MainForm.ShowIcon               = $false

$StartListenBtn                  = New-Object system.Windows.Forms.Button
$StartListenBtn.text             = "Start Listening"
$StartListenBtn.width            = 164
$StartListenBtn.height           = 40
$StartListenBtn.Anchor           = 'right,bottom'
$StartListenBtn.location         = New-Object System.Drawing.Point(225,177)
$StartListenBtn.Font             = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
$StartListenBtn.ForeColor        = [System.Drawing.ColorTranslator]::FromHtml("#ffffff")
$StartListenBtn.BackColor        = [System.Drawing.ColorTranslator]::FromHtml("#417505")

$Label1                          = New-Object system.Windows.Forms.Label
$Label1.text                     = "Web URL for Export"
$Label1.AutoSize                 = $true
$Label1.width                    = 25
$Label1.height                   = 10
$Label1.location                 = New-Object System.Drawing.Point(118,49)
...
$IPLabel.width                   = 25
$IPLabel.height                  = 10
$IPLabel.Anchor                  = 'right,left'
$IPLabel.location                = New-Object System.Drawing.Point(48,80)
$IPLabel.Font                    = New-Object System.Drawing.Font('Microsoft Sans Serif',18)

$ChangeIPBtn                        = New-Object system.Windows.Forms.Button
$ChangeIPBtn.text                   = "Change Address"
$ChangeIPBtn.width                  = 160
$ChangeIPBtn.height                 = 40
$ChangeIPBtn.Anchor                 = 'bottom,left'
$ChangeIPBtn.location               = New-Object System.Drawing.Point(12,177)
$ChangeIPBtn.Font                   = New-Object System.Drawing.Font('Microsoft Sans Serif',12)


$ListenProgBar                       = New-Object System.Windows.Controls.ProgressBar
$ListenProgBar.Name                  = 'ListenProgBar'
$ListenProgBar.Width                 = 340
$ListenProgBar.Height                = 20
$ListenProgBar.IsIndeterminate       = $true
$ListenProgBar.Background            = "White"
$ListenProgBar.Foreground            = "CornflowerBlue"

$ListenProgText                      = New-Object System.Windows.Controls.TextBlock
$ListenProgText.HorizontalAlignment  = "Center"
$ListenProgText.VerticalAlignment    = "Center"
$ListenProgText.FontSize             = 12
$ListenProgText.FontStyle            = "Italic"

$listenStatusText = ""
#$listenStatusBrush = [System.Windows.Media.SolidColorBrush]::new("#CFCFCF")
$listenStatusBrush = "#0000"

$DataContext = New-Object System.Collections.ObjectModel.ObservableCollection[Object]

$DataContext.Add($listenStatusText)
$ListenProgText.DataContext = $DataContext
$textBinding = New-Object System.Windows.Data.Binding -ArgumentList "[0]"
[void][System.Windows.Data.BindingOperations]::SetBinding($ListenProgText,[System.Windows.Controls.TextBlock]::TextProperty, $textBinding)


$DataContext.Add($listenStatusBrush)
$ListenProgBar.DataContext  = $DataContext
$brushBinding = New-Object System.Windows.Data.Binding -ArgumentList "[1]"
[void][System.Windows.Data.BindingOperations]::SetBinding($ListenProgBar,[System.Windows.Controls.ProgressBar]::ForegroundProperty, $brushBinding)


$WPFGrid = New-Object System.Windows.Controls.Grid
$WPFGrid.AddChild($ListenProgBar)
$WPFGrid.AddChild($ListenProgText)
$WPFGrid.Visibility                  = "Hidden"

$progBarHost = New-Object System.Windows.Forms.Integration.ElementHost
$progBarHost.Child                   = $WPFGrid
$progBarHost.Location                = New-Object System.Drawing.Point(30,126)
$progBarHost.Width                   = 340
$progBarHost.Height                  = 25

$ToolTip1                        = New-Object system.Windows.Forms.ToolTip
$ToolTip1.SetToolTip($IPLabel, "This is the address of your local PC `n Type this EXACTLY into the Madden Companion App")

$MainForm.controls.AddRange(@($StartListenBtn,$Label1,$IPLabel,$ChangeIPBtn,$progBarHost))


### Pop-up form for changing IP Address
$IPChangeForm                    = New-Object system.Windows.Forms.Form
$IPChangeForm.ClientSize         = New-Object System.Drawing.Point(200,100)
$IPChangeForm.TopMost            = $false
$IPChangeForm.FormBorderStyle    = 'Fixed3D'
$IPChangeForm.MaximizeBox        = $false
$IPChangeForm.ShowIcon           = $false


$IPChangeOK                      = New-Object system.Windows.Forms.Button
$IPChangeOK.text                 = "OK"
$IPChangeOK.width                = 50
$IPChangeOK.height               = 30
$IPChangeOK.location             = New-Object System.Drawing.Point(70,60)
$IPChangeOK.Font                 = New-Object System.Drawing.Font('Microsoft Sans Serif',12)

$IPAddrBox                       = New-Object system.Windows.Forms.ComboBox
$IPAddrBox.width                 = 150
$IPAddrBox.height                = 20
$IPAddrBox.location              = New-Object System.Drawing.Point(25,20)
$IPAddrBox.Font                  = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
#//NOTE:  This section often falls out of date from a Madden update
#//////////////////////////////////////////////////////////////////
...
#//////////////////////////////////////////////////////////////////
#//Function to close IP Address change dialog
#//////////////////////////////////////////////////////////////////
function CloseIPChange()
{
    $global:ipAddress = $IPAddrBox.Text
    $global:serverAddr = "http://"+$global:ipAddress+":$global:port/"
    $IPLabel.Text = $global:serverAddr.TrimEnd('/')
...
#//////////////////////////////////////////////////////////////////
#//Function to start select an IP address
#//////////////////////////////////////////////////////////////////
function SelectIP()
{
    
    $Addresses = (Get-NetIPAddress | ?{ $_.AddressFamily -eq "IPv4"  -and !($_.IPAddress -match "169") -and !($_.IPaddress -match "127") }).IPAddress
    $IPAddrBox.Items.Clear()
    Foreach ($Address in $Addresses)
    {
        $IPAddrBox.Items.Add($Address.ToString());
    }
    $IPAddrBox.SelectedIndex = 0 #select 1st item by default
    
    $IPChangeForm.controls.AddRange(@($IPChangeOK,$IPAddrBox))
 
    $IPChangeOK.Add_Click({CloseIPChange})

    $IPChangeForm.ShowDialog()
...
function StopServer()
{
  Invoke-RestMethod -Uri "$global:serverAddr/stop/" -DisableKeepAlive
 
  $global:ListenThread.EndInvoke($global:AsyncObject)
  
  
  $WPFGrid.Visibility  = "Hidden"
  $ChangeIPBtn.Enabled = $true
  
  $StartListenBtn.BackColor        = [System.Drawing.ColorTranslator]::FromHtml("#417505")
  $StartListenBtn.Text             = "Start Listening"
  
  $StartListenBtn.Remove_Click($global:doStopServer)
  $StartListenBtn.Add_Click($global:doStartServer)
...
#//////////////////////////////////////////////////////////////////
#//Function to start the server and listen
#//////////////////////////////////////////////////////////////////
function StartServer ()
{
    if ($global:ipAddress -eq "")
    {
      [System.Windows.MessageBox]::Show('No IP Address Found')
      return
    }
    
    $StartListenBtn.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#B70009")
    $StartListenBtn.Text = "Stop Listening"
    $ChangeIPBtn.Enabled = $false
    
    $StartListenBtn.Remove_Click($global:doStartServer)
    $StartListenBtn.Add_Click($global:doStopServer)
    
    $WPFGrid.Visibility = "Visible"
    $MainForm.Refresh()
    
    #Create a thread for the listener
    $Runspace = [runspacefactory]::CreateRunspace()
    $Runspace.Open()
    $Runspace.SessionStateProxy.SetVariable("serverAddr", $global:serverAddr)
    $Runspace.SessionStateProxy.SetVariable('DataContext', $DataContext)
    
    
    #The listener thread is a self-contained script
    $global:ListenThread = [PowerShell]::Create().AddScript(
    {
        ...
        {
             [System.Windows.MessageBox]::Show("Cannot start server at $serverAddr `nScript already running in another window, or bad IP address?")
             return
        }
        ...
        do {
            ...
            $StopListenerBool = $false
            $DataContext[0] = "Listening for Madden Companion App"

            $DataContext[1]="#CFCFCF"
            

            try{
                $context = $listener.GetContext() #script will pause here waiting for Companion App
                
                $DataContext[1] = "#417505"
                ...
                ### This is the uncompressed stream read
                ...
                switch -Wildcard ($requestUrl)
                {
                    ...
                    '*leagueteams' #LEAGUE INFO
                    {
                        ...
                        $infoList | Export-Csv -Path "$filepath\leagueInfo.csv" -NoTypeInformation
                    ...
                    '*standings' #LEAGUE INFO
                    {
                        ...
                        $standingsList | Export-Csv -Path "$filePath\standingsInfo.csv" -NoTypeInformation
		        ...
		        #flatten out abilities
                	$teamList | ForEach-Object {
                        ...
                        $teamList | Export-Csv -Path "$filePath\rosters.csv" -NoTypeInformation
	                ...
	                '*week*' #WEEKLY STATISTICS
                    {
                        ...
                        switch -Wildcard ($requestURL)
                        {
                            '*schedules'
                            {
                                ...
                                $requestJson.gameScheduleInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "SCHEDULE `t => $statFileName"
                                $DataContext[0] = "SCHEDULE Week: $week"

                            }
                            '*defense'
                            {
                                $statFileName = "$($week) defensiveStats.csv"
                                $requestJson.playerDefensiveStatInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "DEFENSIVE STATS  => $statFilename"
                                $DataContext[0] = "DEFENSIVE STATS Week: $week"
                            }
                            '*kicking'
                            {
                                $statFileName = "$($week) kickingStats.csv"
                                $requestJson.playerKickingStatInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "KICKING STATS `t => $statFilename"
                                $DataContext[0] = "KICKING STATS Week: $week"
                            }
                            '*passing'
                            {
                                $statFileName = "$($week) passingStats.csv"
                                $requestJson.playerPassingStatInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "PASSING STATS `t => $filePath\$statFilename"
                                $DataContext[0] = "PASSING STATS Week: $week"
                            }
                            '*punting'
                            {
                                $statFileName = "$($week) puntingStats.csv"
                                $requestJson.playerPuntingStatInfoList| Export-Csv -Path "$filePath\$statFilename"  -NoTypeInformation
                                Write-Host "PUNTING STATS `t => $filePath\$statFilename"
                                $DataContext[0] = "PUNTING STATS Week: $week"
                            }
                            '*receiving'
                            {
                                $statFileName = "$($week) receivingStats.csv"
                                $requestJson.playerReceivingStatInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "RECEIVING STATS  => $filePath\$statFilename"
                                $DataContext[0] = "RECEIVING STATS Week: $week"
                            }
                            '*rushing'
                            {
                                $statFileName = "$($week) rushingStats.csv"
                                $requestJson.playerRushingStatInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "RUSHING STATS `t => $filePath\$statFilename"
                                $DataContext[0] = "RUSHING STATS Week: $week"
                            }
                            '*teamstats'
                            {
                                $statFileName = "$($week) teamStats.csv"
                                $requestJson.teamStatInfoList| Export-Csv -Path "$filePath\$statFilename" -NoTypeInformation
                                Write-Host "TEAM STATS `t => $filePath\$statFilename"
                                $DataContext[0] = "TEAM STATS Week: $week"
                            }
                        }
                        break
                    }            
            ...
            if ($StopListenerBool) {$listener.Stop()}

        } while ($listener.IsListening)
    })
    
    $global:ListenThread.runspace = $Runspace
    $global:AsyncObject = $global:ListenThread.BeginInvoke()

}

$global:doStartServer = {StartServer}
$global:doStopServer = {StopServer}

$StartListenBtn.Add_Click($global:doStartServer)

$ChangeIPBtn.Add_Click({SelectIP})

$global:ipAddress = (Get-NetIPAddress | ?{ $_.AddressFamily -eq "IPv4"  -and ($_.IPAddress -match "192.168")}).IPAddress
$global:serverAddr = "http://"+$global:ipAddress+":$global:port/"
